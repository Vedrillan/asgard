...
use Asgard\Bundle\PlannerBundle\Entity\Race;
use Asgard\Bundle\PlannerBundle\Form\RaceType;
...
class RaceController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AsgardPlannerBundle:Race')->findAll();

        return $this->render('AsgardPlannerBundle:Race:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AsgardPlannerBundle:Race')->find($id);
        ...
        return $this->render('AsgardPlannerBundle:Race:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function newAction()
    {
        ...
        return $this->render('AsgardPlannerBundle:Race:new.html.twig', array(
            'entity' => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('AsgardPlannerBundle:Race:edit.html.twig', array(
            'entity'      => $entity,
